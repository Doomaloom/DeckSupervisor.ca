...
function RosterCard({
    ...
    return (
        <div className="rounded-2xl border-2 border-secondary/20 bg-accent p-6 shadow-md" id={roster.code}>
            ...
            <div className="mt-4 grid grid-cols-1 gap-3 md:grid-cols-[1.2fr_1fr_1fr]">
                ...
                <InstructorSelect
                    ...
                    onChange={value => onRosterInstructorChange(roster.code, value)}
                />
                <LevelSelect value={roster.level} onChange={value => onRosterLevelChange(roster.code, value)} />
            </div>
