          ...
          <div className="rounded-2xl border border-secondary/20 bg-bg p-5">
            ...
            {callScriptMode === 'live' ? (
              <div className="space-y-4 text-base leading-8 text-secondary">
                ...
                <div className="rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-3">
                  ...
                  <p className="mt-2 text-emerald-900">
                    If you decide to move into one of those options, you{"'"}ll receive an email confirmation of the changes.
                  </p>
                </div>
                <div className="rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3">
                  ...
                  <p className="mt-2 text-amber-900">
                    ...
                    Staff at the centre can also help with the next steps regarding your registration.
                  </p>
                </div>
              ...
              <p className="whitespace-pre-line text-base leading-8 text-secondary">
                {`Hello, this is ${callerName} calling from ${callerLocationName} regarding ${activeCallParticipant.name}'s aquatics program.
